...
set output 'all_in_one_time_breakdown_log_webspam_epsilon_4x.png'
...
set title 'Training Time Variation against Block Size : Parallelism = 4'
...
plot newhistogram "Webspam", 'all_log_webspam_epsilon.csv' u "Webspam_Comp":xtic(1) title 'Webspam Computation', '' u "Webspam_Comm" title 'Webspam Communication' , newhistogram "Epsilon", '' u "Epsilon_Comp":xtic(1) title 'Epsilon Computation' , '' u "Epsilon_Comm" title 'Epsilon Communication'

...
set title 'Webspam Dataset : Computation and Communication Time Breakdown [Per Training Process]: m=2'
...
set ylabel 'Time (s)' font 'Helvetica Bold,20'
set key title 'Communication Configuration'
set title 'Webspam Dataset : Computation and Communication Time Breakdown [Per Training Process]: m=8'

...
set output 'acc_n_cost_epoch_comp_ijcnn_c=1,2,4,8,1024,_x32.png'
...
set logscale y
plot 'ijcnn_m=32_c=1_i=5001_mv=10' using 3 title'32x 1c 5001i' with lines,'ijcnn_m=32_c=2_i=5001_mv=10' using 3 title'32x 2c 5001i' with lines,'ijcnn_m=32_c=4_i=5001_mv=10' using 3 title'32x 4c 5001i' with lines,'ijcnn_m=32_c=8_i=5001_mv=10' using 3 title'32x 8c 5001i' with lines,'ijcnn_m=32_c=1024_i=5001_mv=10' using 3 title'32x 1024c 5001i' with lines,
...
unset logscale y
plot 'ijcnn_m=32_c=1_i=5001_mv=10' using 2 title'32x 1c 5001i' with lines,'ijcnn_m=32_c=2_i=5001_mv=10' using 2 title'32x 2c 5001i' with lines,'ijcnn_m=32_c=4_i=5001_mv=10' using 2 title'32x 4c 5001i' with lines,'ijcnn_m=32_c=8_i=5001_mv=10' using 2 title'32x 8c 5001i' with lines,'ijcnn_m=32_c=1024_i=5001_mv=10' using 2 title'32x 1024c 5001i' with lines,

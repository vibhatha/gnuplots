...
set output 'acc_n_cost_epoch_comp_ijcnn_c=1,2,4,8,32,_x4.png'
...
set logscale y
plot 'ijcnn_m=4_c=1_i=5001_mv=10' using 3 title'4x 1c 5001i' with lines,'ijcnn_m=4_c=2_i=5001_mv=10' using 3 title'4x 2c 5001i' with lines,'ijcnn_m=4_c=4_i=5001_mv=10' using 3 title'4x 4c 5001i' with lines,'ijcnn_m=4_c=8_i=5001_mv=10' using 3 title'4x 8c 5001i' with lines,'ijcnn_m=4_c=32_i=5001_mv=10' using 3 title'4x 32c 5001i' with lines,
...
unset logscale y
plot 'ijcnn_m=4_c=1_i=5001_mv=10' using 2 title'4x 1c 5001i' with lines,'ijcnn_m=4_c=2_i=5001_mv=10' using 2 title'4x 2c 5001i' with lines,'ijcnn_m=4_c=4_i=5001_mv=10' using 2 title'4x 4c 5001i' with lines,'ijcnn_m=4_c=8_i=5001_mv=10' using 2 title'4x 8c 5001i' with lines,'ijcnn_m=4_c=32_i=5001_mv=10' using 2 title'4x 32c 5001i' with lines,

...
set key font "Helvetica Bold, 20" right top title 'Configuration [parallelism_x block-size_c]'
set logscale y
...
set key font "Helvetica Bold, 20" right bottom title 'Configuration [parallelism_x block-size_c]'
unset logscale y

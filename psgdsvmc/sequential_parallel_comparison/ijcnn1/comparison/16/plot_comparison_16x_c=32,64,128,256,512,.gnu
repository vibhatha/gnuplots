...
plot 'ijcnn_m=16_c=32_i=5001_mv=10' using 2 title'16x 32c 5001i' with lines, 'ijcnn1_comm_gap=512.csv_mv=10' using 2 title 'Sequential 512c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'ijcnn_m=16_c=64_i=5001_mv=10' using 2 title'16x 64c 5001i' with lines, 'ijcnn1_comm_gap=1024.csv_mv=10' using 2 title 'Sequential 1024c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'ijcnn_m=16_c=128_i=5001_mv=10' using 2 title'16x 128c 5001i' with lines, 'ijcnn1_comm_gap=2048.csv_mv=10' using 2 title 'Sequential 2048c 5001i' with lines 

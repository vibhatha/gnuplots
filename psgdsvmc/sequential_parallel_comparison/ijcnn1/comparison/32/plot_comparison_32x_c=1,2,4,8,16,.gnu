...
plot 'ijcnn_m=32_c=1_i=5001_mv=10' using 2 title'32x 1c 5001i' with lines, 'ijcnn1_comm_gap=32.csv_mv=10' using 2 title 'Sequential 32c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'ijcnn_m=32_c=16_i=5001_mv=10' using 2 title'32x 16c 5001i' with lines, 'ijcnn1_comm_gap=512.csv_mv=10' using 2 title 'Sequential 512c 5001i' with lines 

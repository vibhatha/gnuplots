...
set title 'Variation of Cross-Validation Accuracy: Ijcnn1 Dataset: Block Size=1, Parallelism [1,32]' font 'Helvetica Bold,28'
...
set title 'Variation of Cross-Validation Accuracy : Ijcnn1 Dataset: Block Size=16, Parallelism [1,32]' font 'Helvetica Bold,28'
set key right bottom title 'Configuration [parallelism_{x} block-size_{c}]' font 'Helvetica Bold,26' 
set font 'Helvetica Bold,20'

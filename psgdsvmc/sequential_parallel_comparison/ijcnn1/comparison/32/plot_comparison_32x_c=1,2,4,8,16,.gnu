...
# png
set font 'Helvetica'
set terminal pngcairo size 1920,1080 enhanced color font 'Helvetica Bold,18'
set output 'seq_par_msf_variation_ijcnn1.png' 
...
set title 'Variation of Cross-Validation Accuracy: Ijcnn1 Dataset: Block Size=1, Parallelism [1,32]' font 'Helvetica Bold,22'
set key right bottom title 'Configuration [parallelism_{x} block-size_{c}]' font 'Helvetica Bold,18' 
set font 'Helvetica Bold,14'
...
set title 'Variation of Cross-Validation Accuracy : Ijcnn1 Dataset: Block Size=16, Parallelism [1,32]' font 'Helvetica Bold,22'
set key right bottom title 'Configuration [parallelism_{x} block-size_{c}]' font 'Helvetica Bold,18' 
set font 'Helvetica Bold,14'
plot 'ijcnn_m=32_c=16_i=5001_mv=10' using 2 title'32x 16c' with lines, 'ijcnn1_comm_gap=512.csv_mv=10' using 2 title '1x 16c' with lines 

...
plot 'ijcnn_m=4_c=32_i=5001_mv=10' using 2 title'4x 32c 5001i' with lines, 'ijcnn1_comm_gap=128.csv_mv=10' using 2 title 'Sequential 128c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'ijcnn_m=4_c=64_i=5001_mv=10' using 2 title'4x 64c 5001i' with lines, 'ijcnn1_comm_gap=256.csv_mv=10' using 2 title 'Sequential 256c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'ijcnn_m=4_c=128_i=5001_mv=10' using 2 title'4x 128c 5001i' with lines, 'ijcnn1_comm_gap=512.csv_mv=10' using 2 title 'Sequential 512c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'ijcnn_m=4_c=256_i=5001_mv=10' using 2 title'4x 256c 5001i' with lines, 'ijcnn1_comm_gap=1024.csv_mv=10' using 2 title 'Sequential 1024c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'ijcnn_m=4_c=512_i=5001_mv=10' using 2 title'4x 512c 5001i' with lines, 'ijcnn1_comm_gap=2048.csv_mv=10' using 2 title 'Sequential 2048c 5001i' with lines 

...
plot 'ijcnn_m=8_c=32_i=5001_mv=10' using 2 title'8x 32c 5001i' with lines, 'ijcnn1_comm_gap=32.csv_mv=10' using 2 title 'Sequential 32c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,18' 
set font 'Helvetica,14'
plot 'ijcnn_m=8_c=64_i=5001_mv=10' using 2 title'8x 64c 5001i' with lines, 'ijcnn1_comm_gap=64.csv_mv=10' using 2 title 'Sequential 64c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,18' 
set font 'Helvetica,14'
plot 'ijcnn_m=8_c=128_i=5001_mv=10' using 2 title'8x 128c 5001i' with lines, 'ijcnn1_comm_gap=128.csv_mv=10' using 2 title 'Sequential 128c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,18' 
set font 'Helvetica,14'
plot 'ijcnn_m=8_c=256_i=5001_mv=10' using 2 title'8x 256c 5001i' with lines, 'ijcnn1_comm_gap=256.csv_mv=10' using 2 title 'Sequential 256c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,18' 
set font 'Helvetica,14'
plot 'ijcnn_m=8_c=512_i=5001_mv=10' using 2 title'8x 512c 5001i' with lines, 'ijcnn1_comm_gap=512.csv_mv=10' using 2 title 'Sequential 512c 5001i' with lines 

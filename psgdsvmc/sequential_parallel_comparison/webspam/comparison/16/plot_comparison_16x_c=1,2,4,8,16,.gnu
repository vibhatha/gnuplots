...
plot 'ijcnn_m=16_c=1_i=5001_mv=10' using 2 title'16x 1c 5001i' with lines, 'webspam_c=16.csv_mv=10' using 2 title 'Sequential 16c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'ijcnn_m=16_c=2_i=5001_mv=10' using 2 title'16x 2c 5001i' with lines, 'webspam_c=32.csv_mv=10' using 2 title 'Sequential 32c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'ijcnn_m=16_c=4_i=5001_mv=10' using 2 title'16x 4c 5001i' with lines, 'webspam_c=64.csv_mv=10' using 2 title 'Sequential 64c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'ijcnn_m=16_c=8_i=5001_mv=10' using 2 title'16x 8c 5001i' with lines, 'webspam_c=128.csv_mv=10' using 2 title 'Sequential 128c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'ijcnn_m=16_c=16_i=5001_mv=10' using 2 title'16x 16c 5001i' with lines, 'webspam_c=256.csv_mv=10' using 2 title 'Sequential 256c 5001i' with lines 

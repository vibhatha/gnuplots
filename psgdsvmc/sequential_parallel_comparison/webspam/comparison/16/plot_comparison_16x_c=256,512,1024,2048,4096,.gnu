...
plot 'webspam_p_m=16_c=256_i=5001_mv=10' using 2 title'16x 256c 5001i' with lines, 'webspam_c=256.csv_mv=10' using 2 title 'Sequential 256c 5001i' with lines
...
set key right top title 'Configuration'
plot 'webspam_p_m=16_c=512_i=5001_mv=10' using 2 title'16x 512c 5001i' with lines, 'webspam_c=512.csv_mv=10' using 2 title 'Sequential 512c 5001i' with lines
...
set key right top title 'Configuration'
plot 'webspam_p_m=16_c=1024_i=5001_mv=10' using 2 title'16x 1024c 5001i' with lines, 'webspam_c=1024.csv_mv=10' using 2 title 'Sequential 1024c 5001i' with lines

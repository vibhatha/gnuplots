...
plot 'webspam_p_m=2_c=16_i=5001_mv=10' using 2 title'2x 16c 5001i' with lines, 'webspam_c=16.csv_mv=10' using 2 title 'Sequential 16c 5001i' with lines font 'Helvetica,14'

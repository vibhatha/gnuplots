...
plot 'ijcnn_m=32_c=1_i=5001_mv=10' using 2 title'32x 1c 5001i' with lines, 'webspam_c=1.csv_mv=10' using 2 title 'Sequential 1c 5001i' with lines
...
set key right bottom title 'Configuration'
plot 'ijcnn_m=32_c=2_i=5001_mv=10' using 2 title'32x 2c 5001i' with lines, 'webspam_c=2.csv_mv=10' using 2 title 'Sequential 2c 5001i' with lines
...
set key right bottom title 'Configuration'
plot 'ijcnn_m=32_c=4_i=5001_mv=10' using 2 title'32x 4c 5001i' with lines, 'webspam_c=4.csv_mv=10' using 2 title 'Sequential 4c 5001i' with lines
...
set key right bottom title 'Configuration'
plot 'ijcnn_m=32_c=8_i=5001_mv=10' using 2 title'32x 8c 5001i' with lines, 'webspam_c=8.csv_mv=10' using 2 title 'Sequential 8c 5001i' with lines

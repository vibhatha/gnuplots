...
set title 'Variation of Cross-Validation Accuracy: Webspam Dataset: Block Size=1, Parallelism [1,32]' font 'Helvetica Bold,22'
...
set title 'Variation of Cross-Validation Accuracy: Webspam Dataset: Block Size=16, Parallelism [1,32]' font 'Helvetica Bold,22'
set key right bottom title 'Configuration [parallelism_{x} block-size_{c}]' font 'Helvetica Bold,18'  
set font 'Helvetica Bold,14'

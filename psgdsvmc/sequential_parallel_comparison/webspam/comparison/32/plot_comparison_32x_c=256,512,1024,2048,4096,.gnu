...
plot 'webspam_p_m=32_c=256_i=5001_mv=10' using 2 title'32x 256c 5001i' with lines, 'webspam_c=256.csv_mv=10' using 2 title 'Sequential 256c 5001i' with lines
...
set key right top title 'Configuration'
plot 'webspam_p_m=32_c=512_i=5001_mv=10' using 2 title'32x 512c 5001i' with lines, 'webspam_c=512.csv_mv=10' using 2 title 'Sequential 512c 5001i' with lines

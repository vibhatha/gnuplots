...
plot 'webspam_m=4_c=1_i=5001_mv=10' using 2 title'4x 1c 5001i' with lines, 'webspam_c=4.csv_mv=10' using 2 title 'Sequential 4c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'webspam_m=4_c=2_i=5001_mv=10' using 2 title'4x 2c 5001i' with lines, 'webspam_c=8.csv_mv=10' using 2 title 'Sequential 8c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'webspam_m=4_c=4_i=5001_mv=10' using 2 title'4x 4c 5001i' with lines, 'webspam_c=16.csv_mv=10' using 2 title 'Sequential 16c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'webspam_m=4_c=8_i=5001_mv=10' using 2 title'4x 8c 5001i' with lines, 'webspam_c=32.csv_mv=10' using 2 title 'Sequential 32c 5001i' with lines 
...
set key right bottom title 'Configuration' font 'Helvetica,10' 
set font 'Helvetica,8'
plot 'webspam_m=4_c=16_i=5001_mv=10' using 2 title'4x 16c 5001i' with lines, 'webspam_c=64.csv_mv=10' using 2 title 'Sequential 64c 5001i' with lines 

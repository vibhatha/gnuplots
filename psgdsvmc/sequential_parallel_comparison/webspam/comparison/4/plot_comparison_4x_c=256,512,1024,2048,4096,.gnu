...
plot 'webspam_m=4_c=256_i=5001_mv=10' using 2 title'4x 256c 5001i' with lines, 'webspam_c=256.csv_mv=10' using 2 title 'Sequential 256c 5001i' with lines
...
set key right top title 'Configuration'
plot 'webspam_m=4_c=512_i=5001_mv=10' using 2 title'4x 512c 5001i' with lines, 'webspam_c=512.csv_mv=10' using 2 title 'Sequential 512c 5001i' with lines
...
set key right top title 'Configuration'
plot 'webspam_m=4_c=1024_i=5001_mv=10' using 2 title'4x 1024c 5001i' with lines, 'webspam_c=1024.csv_mv=10' using 2 title 'Sequential 1024c 5001i' with lines
...
set key right top title 'Configuration'
plot 'webspam_m=4_c=2048_i=5001_mv=10' using 2 title'4x 2048c 5001i' with lines, 'webspam_c=2048.csv_mv=10' using 2 title 'Sequential 2048c 5001i' with lines
...
set key right top title 'Configuration'
plot 'webspam_m=4_c=4096_i=5001_mv=10' using 2 title'4x 4096c 5001i' with lines, 'webspam_c=4096.csv_mv=10' using 2 title 'Sequential 4096c 5001i' with lines

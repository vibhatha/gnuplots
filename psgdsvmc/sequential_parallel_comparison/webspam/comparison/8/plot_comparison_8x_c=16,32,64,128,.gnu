...
plot 'ijcnn_m=8_c=16_i=5001_mv=10' using 2 title'8x 16c 5001i' with lines, 'webspam_c=16.csv_mv=10' using 2 title 'Sequential 16c 5001i' with lines
...
set key right bottom title 'Configuration'
plot 'ijcnn_m=8_c=32_i=5001_mv=10' using 2 title'8x 32c 5001i' with lines, 'webspam_c=32.csv_mv=10' using 2 title 'Sequential 32c 5001i' with lines
...
set key right bottom title 'Configuration'
plot 'ijcnn_m=8_c=64_i=5001_mv=10' using 2 title'8x 64c 5001i' with lines, 'webspam_c=64.csv_mv=10' using 2 title 'Sequential 64c 5001i' with lines
...
set key right bottom title 'Configuration'
plot 'ijcnn_m=8_c=128_i=5001_mv=10' using 2 title'8x 128c 5001i' with lines, 'webspam_c=128.csv_mv=10' using 2 title 'Sequential 128c 5001i' with lines

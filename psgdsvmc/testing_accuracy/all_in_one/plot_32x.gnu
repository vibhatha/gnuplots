...
set output 'all_testing_accuracy_variation_32x.png' 
...
plot 'testing_2x_8x_32x_noheader_webspam.csv' using 4 title 'x32 Webspam' with lines, 'testing_2x_8x_32x_noheader_ijcnn1.csv' using 4 title 'x32 Ijcnn1' with lines, 'testing_2x_8x_32x_noheader_epsilon.csv' using 4 title 'x32 Epsilon' with lines

...
set output 'all_testing_accuracy_variation_32x_log.png' 
...
plot 'testing_2x_8x_32x_noheader_webspam_log.csv' using 4 title 'x32 Webspam' with lines, 'testing_2x_8x_32x_noheader_ijcnn1_log.csv' using 4 title 'x32 Ijcnn1' with lines, 'testing_2x_8x_32x_noheader_epsilon_log.csv' using 4 title 'x32 Epsilon' with lines

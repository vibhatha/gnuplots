...
#set label 1 "Epsilon Minimum" at 0.0000, graph 0.1, 0 center norotate back nopoint offset character 0, -1, 0 font 'Helvetica Bold,14'
#set arrow 1 from 1.00000, graph 0.1, 0 to 1.00000, 84.135, 0.00000 head back filled linewidth 1.000 dashtype solid
#set label 2 "Epsilon Maximum" at 128.0000, graph 0.1, 0 center norotate back nopoint offset character 0, 1, 0 font 'Helvetica Bold,14'
...
set xlabel 'Block Size' font 'Helvetica Bold,20'
set ylabel 'Testing Accuracy' font 'Helvetica Bold,20'
set key bottom right title 'Data Source' font 'Helvetica Bold,18'
set key top right font "Helvetica Bold, 18"
set title 'Testing  Accuracy Variation against Block Size: Parallelism = 32' font 'Helvetica Bold,22'
...
plot 'testing_2x_8x_32x_noheader_webspam.csv' using 4 title 'Webspam' with lines, 'testing_2x_8x_32x_noheader_ijcnn1.csv' using 4 title 'Ijcnn1' with lines, 'testing_2x_8x_32x_noheader_epsilon.csv' using 4 title 'Epsilon' with lines, 
#'epsilon_max.csv' using 2 title 'Epsilon Maximum' with points ps 3 pt 2 lc rgb 'red', 'webspam_max.csv' using 2 title 'Webspam Maximum' with points ps 3 pt 2 lc rgb 'green', 'ijcnn1_max.csv' using 2 title 'Ijcnn1 Maximum' with points ps 3 pt 2 lc rgb 'blue'

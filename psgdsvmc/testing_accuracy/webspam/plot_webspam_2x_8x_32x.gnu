...
set output 'webspam_testing_accuracy_variation.png' 
...
set title 'Webspam Dataset: Testing  Accuracy Variation against Block Size' font 'Helvetica,22'
plot 'webspam_testing_2x_8x_32x_noheader.csv' using 3 title 'x8' with lines, '' using 4 title 'x32' with lines
